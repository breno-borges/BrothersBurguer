 ...
 * @author breno
 */
public class ComponentesLanche extends Produtos {

    public ComponentesLanche() {
    }

    public ComponentesLanche(int id, String nome, double valorUnitario, int qtdEmEstoque) {
